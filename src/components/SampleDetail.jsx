            ...
            {activeTab === 'details' && (
              <div>
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                  ...
                  <div className="meta-item"><span className="meta-label">Supplier</span><span className="meta-value">{sample.suppliers?.name ? maskSupplierName(sample.suppliers.name, currentPerson) : '-'}</span></div>
